                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <span class="panel-title">All Roles</span>
                        </div>
                        ...
                        <div class="panel-body">
                            <p>
                                <a class="<?php if(Request::is('*all')) echo 'no-action';?>" href="{{ route('roles.index', 'all') }}">All ({{ $published }})</a>
                                @if($published >= 1) | <a class="<?php if(Request::is('*published')) echo 'no-action';?>" href="{{ route('roles.index', 'published') }}">Published ({{ $published }})</a>@endif 
                                @if($trashed >= 1) | <a class="<?php if(Request::is('*trashed')) echo 'no-action';?>" href="{{ route('roles.index', 'trashed') }}">Trash ({{ $trashed }})</a>@endif
                            </p>
                            {{ Form::open(['route'=>'roles.bulk', 'class'=>'col-md-3', 'style="', 'padding: 0px !important;"']) }}
                            ...
                            {{ Form::close() }}
                            {{ Form::open(['route'=>'roles.create', 'class'=>'col-md-6', 'style="', 'padding: 0px !important;"']) }}
                                <div class="form-group col-md-4" style="padding: 0px;">
                            ...
                            <table id="my-table" class="table table-hover table-striped table-bordered nowrap" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ Form::checkbox('checked-role', $role->id) }}</td>
                                        <td>{{ $role->name }}</td>
                                        <td>{!! $role->display_name !!}</td>
                                        <td>{!! str_limit($role->description, 40) !!}</td>
                                        <td>{{ count($role->authenticated) >= 1?$role->authenticated->first()->username : 'NA' }}</td>
                                        ...
                                        @else
                                        <td align="center">
                                            <a class="btn btn-xs btn-icon btn-circle btn-warning" href="{{ route('roles.edit', $role->id) }}"><i class="fa fa-edit"></i></a> | 
                                            <a href="{{ route('roles.destroy', [$role->id, 'trash']) }}" class="btn btn-xs btn-icon btn-circle btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                        @endif
                                    </tr>
                                    @endforeach
