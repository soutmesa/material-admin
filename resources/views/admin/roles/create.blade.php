			...
			<div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-wysiwyg-2">
                        ...
                        <div class="panel-body">
                            ...
                            <br>
                            {{ Form::text('display_name', old('display_name'), ['class'=>'form-control', 'placeholder'=>'Enter display name ...']) }}
                            <br>
                ...
                <div class="col-md-4">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <select class="multiple-select2 form-control"  name="permissions[]" multiple="multiple">
